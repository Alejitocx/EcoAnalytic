...
-Independencia energética: Reduce la necesidad de importar combustibles fósiles</p>,
    ...
    },
    {
      ...
      details: <p>Los aerogeneradores convierten la energía cinética del viento en energía mecánica a través de las palas que giran cuando el viento las impulsa. <br></br>
       Esta energía mecánica se transmite al generador, donde se convierte en electricidad. <br></br>
       Existen diferentes tipos de aerogeneradores, tanto terrestres como marinos, dependiendo del lugar de instalación y la cantidad de viento disponible.</p>,
    },
  ];
  ...
  return (
    <div className="home">
      ...
      <div className="home-summary">
        ...
        <div className='texto'>
        <p>La energía eólica se ha consolidado como un pilar fundamental en la transición hacia un modelo energético más sostenible y respetuoso con el medio ambiente. <br></br>
        Esta fuente de energía renovable, que aprovecha la fuerza del viento para generar electricidad, ofrece numerosas ventajas que la posicionan como una solución clave para enfrentar los desafíos energéticos y climáticos actuales.<br></br>
